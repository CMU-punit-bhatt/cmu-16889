...
def main(args):
    ...
    create_dir('./logs_locality')

    # Tensorboard Logger
    writer = SummaryWriter('./logs_locality/{0}'.format(args.task+"_"+args.exp_name))
...
def create_parser():
    ...
    parser.add_argument('--checkpoint_dir', type=str, default='./checkpoints_locality/')
